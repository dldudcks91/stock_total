...
> 위치: `scripts/ma20w_short/runs/20260518-2140_crypto_baseline/PLAN.md`
> 작성: 2026-05-18 KST · 마스터 플랜 (모든 후속 run 의 상위 계약)

## 0. 큰 질문

"주봉 MA20 아래에서 숏을 친다" 라는 큰 게이트 안에서,
...
- 무필터 진입: `close[t] < MA20w[t]` → 다음 주 시가 숏
- 청산: `close >= MA20w` 시 다음 주 시가
