...
| [scripts/exit_rule_grid.py](../../scripts/exit_rule_grid.py) | 청산룰 그리드 (simulator) |
| [scripts/validate_clean_dive.py](../../scripts/validate_clean_dive.py) | KR/US 검증 (시기별/Outlier/종목분할/IS-OOS) |
| [scripts/plot_signal_check.py](../../scripts/plot_signal_check.py) | 종목별 차트 + 박치기 카운트 |
| [scripts/plot_r2_intuition.py](../../scripts/plot_r2_intuition.py) | R² 의미 시각화 |
